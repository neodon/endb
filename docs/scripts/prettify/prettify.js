	...
	function D(a, m) {
		function e(a) {
			switch (a.nodeType) {
				case 1:
					...
					if (a.nodeName === 'BR') h(a), a.parentNode && a.remove();
		...
		a.currentStyle
			...
			: window.getComputedStyle &&
			  (l = s.defaultView
					...
					.getPropertyValue('white-space'));
		var p = l && l.substring(0, 3) === 'pre';
		for (l = s.createElement('LI'); a.firstChild; ) l.append(a.firstChild);
		...
		for (var n = Math.max(0, (m - 1) | 0) || 0, g = 0, z = d.length; g < z; ++g)
			(l = d[g]),
				...
				l.firstChild || l.append(s.createTextNode('\u00A0')),
				r.appendChild(l);
		a.append(r);
	}
					...
					for (o = n.parentNode; o; o = o.parentNode)
						if (
							(o.tagName === 'pre' ||
								...
								o.tagName === 'xmp') &&
							o.className &&
							o.className.includes('prettyprint')
						) {
							b = !0;
							break;
						}
