...
(function() {
	...
	const c = e.concat;
	const l = u.toString;
	const f = u.hasOwnProperty;
	const s = e.forEach;
	const p = e.map;
	const h = e.reduce;
	const v = e.reduceRight;
	const g = e.filter;
	const d = e.every;
	const m = e.some;
	const y = e.indexOf;
	...
	typeof exports !== 'undefined'
		...
		: (n._ = j),
		(j.VERSION = '1.5.2');
	const A = (j.each = j.forEach = function(n, t, e) {
		if (n != null)
			if (s && n.forEach === s) n.forEach(t, e);
			else if (n.length === Number(n.length)) {
	...
	const E = 'Reduce of empty array with no initial value';
	(j.reduce = j.foldl = j.inject = function(n, t, r, e) {
		let u = arguments.length > 2;
		if ((n == null && (n = []), h && n.reduce === h))
	...
	(j.contains = j.include = function(n, t) {
		...
		(j.invoke = function(n, t) {
			const r = o.call(arguments, 2);
			const e = j.isFunction(t);
		...
		(j.max = function(n, t, r) {
			if (!t && j.isArray(n) && n[0] === Number(n[0]) && n.length < 65535)
				return Math.max.apply(Math, n);
			if (!t && j.isEmpty(n)) return -1 / 0;
			let e = {computed: -1 / 0, value: -1 / 0};
			return (
				A(n, function(n, u, i) {
					const a = t ? t.call(r, n, u, i) : n;
	...
	const F = function(n) {
		return function(t, r, e) {
			const u = {};
			const i = r == null ? j.identity : k(r);
			return (
				A(t, function(r, a) {
					const o = i.call(e, r, a, t);
					n(u, o, r);
				}),
				u
			);
	...
	(j.groupBy = F(function(n, t, r) {
		...
		(j.first = j.head = j.take = function(n, t, r) {
			return n == null ? void 0 : t == null || r ? n[0] : o.call(n, 0, t);
		}),
		(j.initial = function(n, t, r) {
			return o.call(n, 0, n.length - (t == null || r ? 1 : t));
		}),
	...
	(j.flatten = function(n, t) {
		...
		(j.intersection = function(n) {
			...
			return j.filter(j.uniq(n), function(n) {
				return j.every(t, function(t) {
					return j.includes(t, n);
				});
			});
		}),
		(j.difference = function(n) {
			const t = c.apply(e, o.call(arguments, 1));
		...
		(j.zip = function() {
			for (
				...
				t[r] = j.pluck(arguments, String(r));
			return t;
		}),
		...
		(j.lastIndexOf = function(n, t, r) {
			...
			for (let u = e ? r : n.length; u--; ) if (n[u] === t) return u;
			return -1;
		}),
	...
	(j.bind = function(n, t) {
		...
		return (
			...
			(e = function() {
				...
				const u = new R();
				R.prototype = null;
				const i = n.apply(u, r.concat(o.call(arguments)));
				return new Object(i) === i ? i : u;
			})
		);
	}),
		...
		(j.memoize = function(n, t) {
			...
			return (
				t || (t = j.identity),
				function() {
					const e = Reflect.apply(t, this, arguments);
					return j.has(r, e)
						? r[e]
						: (r[e] = Reflect.apply(n, this, arguments));
				}
			);
		}),
		...
		(j.once = function(n) {
			...
			return function() {
				return r
					? t
					: ((r = !0), (t = Reflect.apply(n, this, arguments)), (n = null), t);
			};
		}),
		(j.wrap = function(n, t) {
			return function() {
		...
		(j.after = function(n, t) {
			return function() {
				return --n < 1 ? Reflect.apply(t, this, arguments) : void 0;
			};
		}),
		(j.keys =
			w ||
			function(n) {
				if (n !== new Object(n)) throw new TypeError('Invalid object');
				const t = [];
				for (const r in n) j.has(n, r) && t.push(r);
				return t;
			}),
		(j.values = function(n) {
		...
		(j.functions = j.methods = function(n) {
			const t = [];
			for (const r in n) j.isFunction(n[r]) && t.push(r);
			return t.sort();
		}),
		(j.extend = function(n) {
			return (
				A(o.call(arguments, 1), function(t) {
					if (t) for (const r in t) n[r] = t[r];
				}),
				n
			);
		}),
		(j.pick = function(n) {
			const t = {};
			const r = c.apply(e, o.call(arguments, 1));
			return (
				A(r, function(r) {
					r in n && (t[r] = n[r]);
				}),
		...
		(j.omit = function(n) {
			const t = {};
			const r = c.apply(e, o.call(arguments, 1));
			for (const u in n) j.contains(r, u) || (t[u] = n[u]);
			return t;
		}),
		(j.defaults = function(n) {
			return (
				A(o.call(arguments, 1), function(t) {
					if (t) for (const r in t) n[r] === void 0 && (n[r] = t[r]);
				}),
				n
			);
		}),
	...
	var S = function(n, t, r, e) {
		...
		for (let i = r.length; i--; ) if (r[i] == n) return e[i] == t;
	...
	(j.isEqual = function(n, t) {
		...
		(j.isEmpty = function(n) {
			...
			for (const t in n) if (j.has(n, t)) return !1;
			return !0;
		}),
		...
		(j.isNaN = function(n) {
			return j.isNumber(n) && n != Number(n);
		}),
		(j.isBoolean = function(n) {
			return n === !0 || n === !1 || l.call(n) == '[object Boolean]';
		}),
		(j.isNull = function(n) {
			return n === null;
		}),
		...
		(j.times = function(n, t, r) {
			for (var e = new Array(Math.max(0, n)), u = 0; n > u; u++)
				e[u] = t.call(r, u);
			return e;
		}),
	...
	j.each(['escape', 'unescape'], function(n) {
		j[n] = function(t) {
			return t == null
				? ''
				: String(t).replace(T[n], function(t) {
						return I[n][t];
				  });
		};
	}),
